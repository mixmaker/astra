...
class RandomWallsPage extends StatelessWidget {
  RandomWallsPage({super.key});
  final Controller controller = Get.find();

  Future<void> _onRefresh() async {
    controller.updateRandom(ListOfWalls(data: <Wall>[]));
                      ...
                      Padding(
                        ...
                        child: GetX<Controller>(builder: (controller) {
                          return Container(
                              ...
                              child: controller.randomWalls().data.isEmpty
                                  ? Padding(
                                  ...
                                  : GridView.builder(
                                      ...
                                      shrinkWrap: true,
                                      itemCount:
                                          controller.randomWalls().data.length,
